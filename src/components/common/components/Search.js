...
import { Form, Input, Button, DatePicker, Select, Icon, Radio,TreeSelect } from 'antd';
                ...
                return(
                  <FormItem className={`${value.className} ${Styles.itemWrapper}`} label={value.name} key={index}>
                    ...
                    <TreeSelect
                      ...
                      onChange={(e=>this.treeSelectChange(`${value.key}`,e))}
